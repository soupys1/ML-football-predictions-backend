...
app = Flask(__name__)
CORS(app, origins=["http://localhost:5173", "http://127.0.0.1:5173", "https://ml-football-predictions-frontend.vercel.app", "https://football-predictor-frontend.netlify.app", "https://ml-football-predictions-frontend-hdsm6krhp-soupys1s-projects.vercel.app"], supports_credentials=True)
